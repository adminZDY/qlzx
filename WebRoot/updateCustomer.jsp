		...
		%>
  		<div style="margin-left: 30px;">
	    	<div class="products_nav">
	       		<img src="/qlzx/images/site_ico.gif"/><span style="font-size: 16px">你所在的位置：<a href="/qlzx/index.jsp">网站首页</a> &gt; 注册登录
	        </span>
	        </div>
	        <div id = "main_bottom">
	        	<!-- 注册 -->
	        	<div class="register" id = "register">
	                ...
	                <div class = "register_table" >
	                	<form  method="post" onsubmit="return ifOk()" name="form_login" action="/qlzx/servlet/CustomerManage?op=updateDetail">
					      <table  width="1000" height="170" cellpadding="0">
					      	  <tr>
					      	  	<td colspan="3" style="border-bottom: 1px solid #000;">
					      	  		<img src="/qlzx/images/peisong_logo.gif"/>修改配送消息
					      	  	</td>
					      	  </tr>
					          <tr>
					            <td>收货人姓名：</td>
					          ...
					          <tr>
					          	...
					          	<td colspan="2" style="border:0px;">
					          		...
					          		<input type="submit" value="提交" class="btn  btn-primary" style="width:60px;"/>
					          		<input type="reset" value="重置" class="btn btn-success" style="width:60px;"/>
